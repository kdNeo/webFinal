...
public class LoadCheckoutHistory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (invoice_list.isEmpty()) {
                resp.getWriter().write("<h4>No Checkout History Found</h4>");
            } else {
                ...
                RequestDispatcher rd = req.getRequestDispatcher("checkouthistoryview.jsp");
        ...
        Log4j.exceptionss(appPath,e.getMessage()+" "+"-"+"LoadCheckOutHistory Servlet error");
        }
    }
