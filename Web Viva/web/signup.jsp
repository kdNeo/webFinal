                    ...
                    <div class="form-box" align="center" 
                        ...
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3 style="font-style: oblique;font-family: sans-serif; font-weight: bold;">Sign Up Now</h3>
                            </div>
                        </div>
                        <br/>
                        <div class="form-bottom">
                            <form role="form" action="javascript:checkPassword()" method="post" class="registration-form">
                                <div class="form-group">
                                    <label class="sr-only" for="form-full-name">Full name</label>
                                    <input type="text" name="form-full-name" placeholder="Full name..." class="form-full-name form-control" maxlength="40" id="form-full-name" required>
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-email">Email</label>
                                    <input type="email" name="form-email" placeholder="Email..." class="form-email form-control" onkeyup="ValidateEmail()" maxlength="40" id="form-email" required>
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-password">Password</label>
                                    <input type="password" name="form-password" placeholder="Password..." class="form-password form-control" id="form-password" maxlength="40" aria-describedby="passwordHelpBlock" required>
                                    <small id="passwordHelpBlock" class="form-text text-muted" align="left">Password must be at least eight characters</small>
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-confirmpassword">Confirm Password</label>
                                    <input type="password" name="form-confirmpassword" placeholder="Confirm Password..." class="form-confirmpassword form-control" id="form-confirmpassword" maxlength="40" aria-describedby="passwordHelpBlock" required>
                                    <small id="passwordHelpBlock" class="form-text text-muted" align="left">Password must be at least eight characters</small>
                                </div>
                                <button type="submit" class="btn btn-dark btn-lg mr-sm-2">Sign Up</button>
                                <p>Already have an account? <a href="login.jsp">Sign In Now</a></p>
