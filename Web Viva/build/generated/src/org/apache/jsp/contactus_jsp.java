...
public final class contactus_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("    </head>\n");
      out.write("    <body onload=\"getCartQuantity();\">        \n");
      out.write("\n");
      ...
      out.write("                            <form role=\"form\" action=\"JavaScript:SendMail()\" method=\"post\" class=\"login-form\">\n");
      out.write("                                <div class=\"form-group\">\n");
      out.write("                                    <label class=\"sr-only\" for=\"form-email\">Email</label>\n");
      out.write("                                    <input type=\"text\" name=\"form-email\" placeholder=\"Email...\" class=\"form-email form-control\" id=\"form-email\" onkeyup=\"ValidateEmail()\" required>\n");
      out.write("                                </div>\n");
      out.write("                                <div class=\"form-group\">\n");
      out.write("                                    <label class=\"sr-only\" for=\"form-message\">Message</label>\n");
      out.write("                                    <textarea type=\"text\" name=\"form-message\" placeholder=\"Message...\" class=\"form-message form-control\" id=\"form-message\" required></textarea>\n");
      out.write("                                </div>\n");
      out.write("                                <button type=\"submit\" class=\"btn btn-dark btn-lg btn-block\">Submit</button>\n");
      out.write("                                  <p id=\"showmessage\" style=\"font-weight: lighter; font-family: Stencil Std, fantasy\"></p>\n");
      out.write("                                 \n");
      out.write("                                  \n");
      out.write("                                 <img id=\"i1\" src=\"\"/>\n");
      out.write("                              \n");
      out.write("                            </form>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      ...
      out.write(" ");
                        ...
                        SessionFactory factory = NewHibernateUtil.getSessionFactory();
                        Session s = factory.openSession();
            Criteria cc = s.createCriteria(Contactus.class);
            cc.add(Restrictions.eq("id", 1));
            Contactus ccc = (Contactus)cc.uniqueResult();
      ...
      out.write("        \n");
      out.write("     \n");
      out.write("                <div class=\"col-1 middle-border\"></div>\n");
      out.write("\n");
      out.write("                <div class=\"col-4 justify-content-center\">\n");
      out.write("                    <br/><br/><br/><br/><br/><br/>\n");
      out.write("\n");
      out.write("                    <div align=\"center\" class=\"card\">\n");
      out.write("                        <div class=\"card-body\">\n");
      out.write("                            <h5 class=\"card-title\">Email:</h5>\n");
      out.write("                            <p class=\"card-text\">");
      out.print(ccc.getEmail() );
      out.write("</p>\n");
      out.write("                            <br/>\n");
      out.write("                            <h5 class=\"card-title\">Contact No:</h5>\n");
      out.write("                            <p class=\"card-text\">");
      out.print("+"+ccc.getConatctno() );
      out.write("</p>\n");
      out.write("                            <br/>\n");
      out.write("                            <h5 class=\"card-title\">Address:</h5>\n");
      out.write("                            <p class=\"card-text\">");
      out.print( ccc.getAddress() );
      out.write("</p>\n");
      out.write("                            <br/>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
