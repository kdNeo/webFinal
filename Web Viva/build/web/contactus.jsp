                ...
                <div class="col-7">
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-bottom">
                            <form role="form" action="JavaScript:SendMail()" method="post" class="login-form">
                                <div class="form-group">
                                    <label class="sr-only" for="form-email">Email</label>
                                    <input type="text" name="form-email" placeholder="Email..." class="form-email form-control" id="form-email" onkeyup="ValidateEmail()" required>
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-message">Message</label>
                                    <textarea type="text" name="form-message" placeholder="Message..." class="form-message form-control" id="form-message" required></textarea>
                                </div>
                ...
                <div class="col-4 justify-content-center">
                    ...
                    <div align="center" class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><%=ccc.getEmail() %></p>
                            <br/>
                            <h5 class="card-title">Contact No:</h5>
                            <p class="card-text"><%="+"+ccc.getConatctno() %></p>
                            <br/>
                            <h5 class="card-title">Address:</h5>
                            <p class="card-text"><%= ccc.getAddress() %></p>
                            <br/>
                        </div>
                    </div>
