                    ...
                    <div class="form-box" align="center" 
                        ...
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3 style="font-style: oblique;font-family: sans-serif; font-weight: bold;">Reset Password</h3>
                            </div>
                        </div>
                        <br/>
                        <div class="form-bottom">
                            <form role="form" action="JavaScript:resetPassword()" method="post" class="login-form">
                                ...
                                <button type="submit" class="btn btn-dark btn-lg mr-sm-2">Change Password</button><br/><br/>
